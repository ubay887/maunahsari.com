...
import DailyCompass from '@/components/ui/DailyCompass';
import IslamicPattern, { SectionDivider, OrnamentalCorner } from '@/components/ui/IslamicPattern';
import AnimatedCounter from '@/components/ui/AnimatedCounter';
import { articles } from '@/features/article/data/articles';
import { useNavigation } from '@/contexts/NavigationContext';

// Local Assets
import gusHamidImg from '@/assets/images/people/gus_hamid.png';
import agusKhalafImg from '@/assets/images/people/agus_khalaf.png';
    ...
    <div className="space-y-16 py-8 md:py-12">
      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-card border border-primary/5 hover:border-secondary/30 rounded-2xl p-6 shadow-sm hover:shadow-md transition-standard card-interactive relative overflow-hidden group text-left">
            ...
            <div className="bg-primary/5 w-12 h-12 rounded-xl flex items-center justify-center text-primary mb-4 group-hover:bg-primary group-hover:text-white transition-standard">
      ...
      <div className="bg-primary text-white py-12 border-y-4 border-secondary/30 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center space-y-1">
            ...
            <span className="block text-[11px] text-white/70 uppercase font-semibold tracking-wider">Tahun Berdiri</span>
          </div>
          <div className="text-center space-y-1">
            <span className="block text-4xl md:text-5xl font-bold font-display text-secondary">
              <AnimatedCounter end={3000} suffix="+" />
            </span>
            <span className="block text-[11px] text-white/70 uppercase font-semibold tracking-wider">Alumni Tersebar</span>
          </div>
          <div className="text-center space-y-1">
            <span className="block text-4xl md:text-5xl font-bold font-display text-secondary">
              <AnimatedCounter end={2} />
            </span>
            <span className="block text-[11px] text-white/70 uppercase font-semibold tracking-wider">Kompleks (Putra & Putri)</span>
          </div>
          <div className="text-center space-y-1">
            <span className="block text-4xl md:text-5xl font-bold font-display text-secondary">
              <AnimatedCounter end={100} suffix="%" />
            </span>
            <span className="block text-[11px] text-white/70 uppercase font-semibold tracking-wider">Sanad Muttashil</span>
          </div>
        </div>
      </div>
      ...
      <div className="container-custom space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-card border border-primary/5 hover:border-secondary/20 rounded-2xl p-6 md:p-8 shadow-sm flex gap-4 items-start card-interactive text-left">
      ...
      <div className="bg-primary/5 py-12 border-y border-primary/5 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Quote 1 */}
            <div className="bg-card border border-primary/5 rounded-2xl p-6 md:p-8 shadow-sm text-left relative space-y-4 flex flex-col justify-between overflow-hidden">
              ...
              <blockquote className="text-muted-foreground text-sm italic leading-relaxed pt-2 z-10">
              ...
              <div className="border-t border-primary/10 pt-3 flex items-center gap-3 z-10">
                ...
                <div>
                  ...
                  <span className="block text-[10px] text-muted-foreground uppercase tracking-wider">Pengasuh PTQ Ma'unah Sari</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-card border border-primary/5 rounded-2xl p-6 md:p-8 shadow-sm text-left relative space-y-4 flex flex-col justify-between overflow-hidden">
              ...
              <div className="border-t border-primary/10 pt-3 flex items-center gap-3 z-10">
                ...
                <div>
                  ...
                  <span className="block text-[10px] text-muted-foreground uppercase tracking-wider">Keluarga Pengasuh / Dewan Pengajar</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="container-custom">
        <div className="bg-card border-2 border-secondary/20 rounded-3xl p-6 md:p-10 shadow-md relative overflow-hidden text-left flex flex-col lg:flex-row gap-8 items-center card-interactive">
          ...
          <div className="space-y-5 flex-grow z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 border-t border-primary/10 pt-5">
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-[11px] leading-snug">Isi formulir pendaftaran melalui situs resmi atau datang langsung.</p>
              </div>
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-[11px] leading-snug">Serahkan berkas administrasi dan ikuti tes penempatan kelas/bin-nadhor.</p>
              </div>
              <div className="space-y-1">
                ...
                <p className="text-muted-foreground text-[11px] leading-snug">Serah terima santri ke pihak pondok, pembagian asrama, dan orientasi.</p>
              </div>
            </div>
          </div>
      ...
      <div className="container-custom space-y-8">
        ...
        <div className="flex overflow-x-auto gap-6 pb-6 pt-2 scrollbar-custom text-left -mx-4 px-4 sm:mx-0 sm:px-0">
          {articles.slice(0, 4).map((post) => (
            <article
              key={post.slug}
              className="min-w-[280px] sm:min-w-[340px] max-w-[340px] bg-card border border-primary/5 hover:border-secondary/30 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-standard flex flex-col justify-between card-interactive"
            >
              <img
                src={post.image}
                alt={post.title}
              ...
              <div className="p-5 flex-grow flex flex-col justify-between space-y-3">
                ...
                <button
                  onClick={() => navigate('artikel-detail', post.slug)}
