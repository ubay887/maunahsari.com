        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            {contacts.map((contact, idx) => (
              <div key={idx} className="bg-card border border-primary/5 rounded-2xl p-5 shadow-sm space-y-3">
            ...
            {socialMedia.map((media, idx) => {
              ...
              return (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className={`bg-card border border-primary/5 rounded-2xl p-4 shadow-sm flex flex-col justify-between hover:border-secondary transition-standard group focus:outline-none focus-ring`}
                >
                  <Icon className={`icon-md text-muted-foreground transition-colors ${media.color} group-hover:scale-105`} />
                  <div className="mt-4 text-left">
                    <span className="block text-[10px] text-muted-foreground uppercase font-bold tracking-wide">{media.name}</span>
