...
export default function Profil() {
  ...
  return (
    <div className="py-8 md:py-12 px-4 max-w-4xl mx-auto space-y-8">
      ...
      {/* Tab Contents */}
      <div className="bg-card border border-primary/5 rounded-2xl p-6 md:p-8 shadow-sm text-left">
        ...
        {activeTab === 'sejarah' && (
          <div className="space-y-6">
            ...
            <div className="text-muted-foreground text-sm space-y-2">
              ...
              <address className="bg-background p-4 rounded-xl not-italic font-semibold text-primary border border-primary/5">
        ...
        {activeTab === 'pendiri' && (
          <div className="space-y-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 bg-background/50 p-4 rounded-xl border border-primary/5 text-xs text-muted-foreground">
