...
export default function DailyCompass() {
  ...
  return (
    <div className="bg-card border border-primary/5 rounded-2xl p-6 md:p-8 shadow-md relative overflow-hidden">
      ...
      <div className="grid md:grid-cols-2 gap-8 items-center relative z-10">
        ...
        <div className="flex justify-center">
          <div className="relative w-64 h-64 md:w-72 md:h-72 rounded-full border-4 border-secondary/25 flex items-center justify-center">
            {/* Inner Ring */}
            <div className="absolute w-48 h-48 md:w-56 md:h-56 rounded-full border border-primary/10 flex items-center justify-center bg-card shadow-inner">
              {/* Display inside Dial */}
              <div className="text-center p-4">
                <activeItem.icon className="w-8 h-8 md:w-10 md:h-10 mx-auto text-secondary animate-float" />
                <span className="block text-xs text-muted-foreground font-mono tracking-wider mt-2">
                  {activeItem.time}
                </span>
                ...
                <button
                  ...
                  className={`absolute w-12 h-12 rounded-full flex items-center justify-center shadow-md border transition-standard focus:outline-none focus-ring ${
                    activeId === item.id
                      ...
                      : 'bg-card border-primary/10 text-primary hover:border-secondary hover:text-secondary'
                  }`}
        ...
        <div className="flex flex-col justify-center bg-card/50 border border-primary/5 rounded-xl p-6 shadow-sm backdrop-blur-sm">
