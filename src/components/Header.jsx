        ...
        <div className="hidden md:flex items-center gap-8">
          <nav className="flex items-center gap-6" aria-label="Menu Utama">
            ...
            <div className="relative group">
              ...
              {/* Dropdown panel */}
              <div className="absolute top-full left-0 mt-1 w-44 rounded-lg bg-bg-surface border border-primary/10 shadow-lg py-2 opacity-0 invisible translate-y-1 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 focus-within:opacity-100 focus-within:visible focus-within:translate-y-0 transition-all duration-200 z-50">
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-xs font-semibold tracking-wide transition-colors hover:bg-primary/5 hover:text-primary ${
                    activePage === 'putra' ? 'text-primary bg-primary/5' : 'text-text-muted'
                  }`}
                >
                  Pondok Putra
                </button>
                <button
                  ...
                  className={`w-full text-left px-4 py-2 text-xs font-semibold tracking-wide transition-colors hover:bg-primary/5 hover:text-primary ${
                    activePage === 'putri' ? 'text-primary bg-primary/5' : 'text-text-muted'
                  }`}
                >
                  Pondok Putri
                </button>
      ...
      {isOpen && (
        <div
          className={`md:hidden border-b transition-all duration-300 ${
            isHome ? 'bg-primary/98 border-white/10' : 'bg-bg-surface border-primary/10'
          }`}
        >
          <nav className="flex flex-col p-4 gap-2" aria-label="Menu Mobile">
            ...
            {/* Registration CTA Button at the bottom of Mobile Drawer */}
